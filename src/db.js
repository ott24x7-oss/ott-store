...
function seedDefaults(db) {
  const defaults = {
    ...
    onboarding_enabled: '1', // getting-started checklist + order guide on the customer dashboard
    app_theme: 'gold', // /app colour theme: gold|purple|green|blue|red|light (admin-selectable)
